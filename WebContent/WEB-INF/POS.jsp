...
<body style="background: #040404;">
    ...
    <sql:query dataSource="${db}" var="area">
           SELECT area_id, area_name, area_desc, area_status FROM rms_area;
        </sql:query>
                                            ...
                                            <table class="display table table-bordered table-striped" id="dynamic-table">
                                                ...
                                                <c:set var="count" value="0" scope="page" />
                                                  	<c:forEach var="row" items="${area.rows}" >
										                    ...
										                    <td><c:out value="${row.area_datetime}"/></td>  
					                                     
					                                     	<td>
					                                     	<input type="hidden" id="area-${count}" value="${row.area_id}">
					                                     	<a class="btn btn-warning " id="available-${count}" style="" data-toggle="modal" data-target=".bs-example-modal-lg-3" onclick="setIndex(${count});"><i class="fa fa-glass"></i></a>
					                                     	<a class="btn btn-success "  id="order-${count}" style="visibility:hidden;  margin-left: 1%" href="category.jsp"><i class="fa fa-plus"  ></i></a>
					            							<a class="btn btn-default " id="billout-${count}" style="visibility:hidden; margin-left: 1%"><i class="fa fa-usd"></i></a>
					            							<a class="btn btn-black " id="cancel-${count}"  style="visibility:hidden; margin-left: 1%"><i class="fa fa-times"></i></a></td>  
									                   </tr>
                ...
                <div class="modal-content" id="sad">
                    ...
                    <div class="modal-body">
                        <div class="input-group">
                         ...
                         <div class="input-group">
                            <span class="input-group-addon"><i class=""><img src="images/quan.png" alt=""  style="height: 57%"/></i></span>
                            <input type="text" class="form-control" placeholder="Remarks" name="remarks" id="remarks" />
                        </div><br/>
                        <div>
                            <button class="btn btn-primary pull-right" id="submit" type="button">Add Customer</button></div><br><br>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $("#submit").click(function(){
            document.getElementById("order-"+idIndex).style.visibility = "visible";
            document.getElementById("billout-"+idIndex).style.visibility = "visible";
            document.getElementById("cancel-"+idIndex).style.visibility = "visible";
